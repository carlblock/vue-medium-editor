...
"use strict";
/* harmony import */ var medium_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    createAndSubscribe() {
      ...
      this.api = new medium_editor__WEBPACK_IMPORTED_MODULE_0___default.a(this.$refs.element, this.options); // bind edit operations to model
      // we need to store the handler in order to later on detach it again

      this.emit = event => this.$emit('edit', {
        event,
        api: this.api
      });

      this.api.subscribe('editableInput', this.emit); // emit event to give parent access to MediumEditor instance
  ...
  MediumEditor: (medium_editor__WEBPACK_IMPORTED_MODULE_0___default())
});
...
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var _interactive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _renderOnly__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
// Because Medium Editor does not support SSR, we just render in that case


/* harmony default export */ __webpack_exports__["default"] = (process.browser ? _interactive__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] : _renderOnly__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(1)))
